...
namespace LibreriaParraJr
{
    ...
    class CrearTicket
    {
        //creamos un ojeto  de la clase StringBuilder, agregaremos las lineas del ticket

        StringBuilder linea = new StringBuilder();
        //Creamos una variable ara almacenar el numero maximo de caracteres que permitiremos en el ticker

        int maxCar = 47, cortar;//Para una impresera de voucher que imprimer 40 columna, la variabla
        //cortar cortara el texto cuando rebase el limite

        //Este metodo dibuja guiones;
        ...
        // Metodo que dibuja linea de asterisco
        ...
        //Metodo que dibuja linea de signo igual
        ...
        public void TextoIzquierda(string texto)
        {
            ...
            {
                int caracterActual = 0;//nos indicacra en que caracter se quedo al bajar el texto a la siguiente linea.
        ...
        //Creamos un metodo para poner le texto a la derecha.
        public void TextoDerecha(string texto)
        {
            if (texto.Length > maxCar)
            {
                ...
                //varaible para poner espacios restantes
                string espacios = "";

                //Obtnemos la longitud del texto restante.
                for (int i =0; i< (maxCar - texto.Substring(caracterActual,texto.Length - caracterActual).Length); i++)
                {
                    espacios = " ";
                }

                //agregamos el fragmento restante, agregamos antes del texto de los espacios;
        ...
        {
            //varaibles que utilizaremos
            string textoIzq="", textoDer="", textoCompleto = "", espacios = "";
            //Si el texto que va a la izquiera es mayor a 18, cortamos el texto.
            if(textoIzquierdo.Length > 18)
            {
                cortar = textoIzquierdo.Length - 8;
            ...
            linea.AppendLine(textoCompleto); //agregams la linea al ticket, al objeto en si.

        }

        //Medo para agregalos totales de las ventas
        public void AgregarTotales (string texto, decimal total)
        {
            ...
            valor = total.ToString("#,#.0"); //Agregamos el total previo formateo
